...
ADD CONSTRAINT FK_ChamCong_TaiKhoan
FOREIGN KEY (IdTaiKhoan) REFERENCES TaiKhoan(Id);
GO

ALTER TABLE KyLuat
ADD CONSTRAINT FK_KyLuat_TaiKhoan
FOREIGN KEY (IdTaiKhoan) REFERENCES TaiKhoan(Id);
GO
...
ALTER TABLE PhanHoi ADD CONSTRAINT FK_PhanHoi_TaiKhoan FOREIGN KEY (IdTaiKhoan) REFERENCES TaiKhoan(Id);
GO

ALTER TABLE LopHoc ADD NgayBatDau DATE;
ALTER TABLE LopHoc ADD TrangThai NVARCHAR(50) DEFAULT N'Chuẩn bị'; 
GO
